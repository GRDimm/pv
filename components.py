...
class InputTextComponent:
    ...
    def set_data(eslf, full_data, dataset_config):
        self.data = full_data
        self.dataset_config = dataset_config
    ...
    def layout(self):
        ...
        return html.Div([
            html.Div([
                ...
                dcc.Input(id='input-id', type='text', placeholder="Filter IDs", className="dark-mode-search-input"),
                dcc.Dropdown(
                    id='operation_id',
                    options=[{'label': rid, 'value': rid} for rid in self.data[self.dataset_config["columns_config"]["id"]]][:int(self.dataset_config["max_dropdown_elements"])],
...
class FeatureImportanceComponent:
    ...
    def layout(self):
        ...
        return html.Div([
            ...
            html.Hr(className='HR'),
            html.Div(
                dcc.Graph(id="feature_importance_graph", className="graph-scale"),
